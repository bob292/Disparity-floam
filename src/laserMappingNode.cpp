...
int main(int argc, char **argv)
{
    ...
    ros::spin();
    pcl::PointCloud<pcl::PointXYZI>::Ptr resultcloud = laserMapping.getMap();
    pcl::io::savePCDFileASCII("/floam/result_cloud.pcd",*resultcloud);
    std::cerr<<"Saved "<<resultcloud->size()<<" data map points into file"<<std::endl;	    
